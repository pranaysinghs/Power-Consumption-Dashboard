...
# Header
st.markdown("""
<h1>Real-time Power Consumption Analysis & Forecasting</h1>
...
with col_insights:
    ...
    with insights_container:
        ...
        <div style='background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 15px; border-radius: 10px; margin-bottom: 15px; color: white;'>
            <h4 style='color: #00f2fe; margin-bottom: 8px; font-size: 1.1rem;'>Peak Usage</h4>
            <p style='font-size: 1.4rem; margin: 0; font-weight: bold;'>{metrics['peak']:.1f} MW</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div style='background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 15px; border-radius: 10px; margin-bottom: 15px; color: white;'>
            <h4 style='color: #00f2fe; margin-bottom: 8px; font-size: 1.1rem;'>Minimum Usage</h4>
            <p style='font-size: 1.4rem; margin: 0; font-weight: bold;'>{metrics['minimum']:.1f} MW</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        st.markdown(f"""
        <div style='background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 15px; border-radius: 10px; margin-bottom: 15px; color: white;'>
            <h4 style='color: #00f2fe; margin-bottom: 8px; font-size: 1.1rem;'>Volatility</h4>
            <p style='font-size: 1.4rem; margin: 0; font-weight: bold;'>{df[selected_state].std():.1f} MW</p>
        </div>
        """, unsafe_allow_html=True)
        
        # Load Factor
        st.markdown(f"""
        <div style='background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 15px; border-radius: 10px; margin-bottom: 0; color: white;'>
            <h4 style='color: #00f2fe; margin-bottom: 8px; font-size: 1.1rem;'>Load Factor</h4>
            <p style='font-size: 1.4rem; margin: 0; font-weight: bold;'>{(metrics['average']/metrics['peak']*100):.1f}%</p>
        </div>
        """, unsafe_allow_html=True)
